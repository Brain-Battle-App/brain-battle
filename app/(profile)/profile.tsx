...
const Profile = ({ navigation }: any) => {
  ...
  const livePopupBottomSheetModalRef = useRef<any>(null);
  const qrCodeBottomSheetModalRef = useRef<any>(null);
    ...
    return (
      <View style={{ ...appStyles.rowjustify }}>
        <View style={{ ...appStyles.row, gap: scale(10) }}>
          ...
          <CustomText label="Profile" size={20} 
        ...
        <View style={{ ...appStyles.row, gap: scale(10) }}>
          <TouchableOpacity
            activeOpacity={0.4}
            onPress={() => livePopupBottomSheetModalRef.current.present()}
          >
            <ImageBackground
              style={{
              ...
              resizeMode="contain"
            >
              <CustomText label="4" size={11} color={theme.colors.white} />
            </ImageBackground>
          </TouchableOpacity>
          <TouchableOpacity
            activeOpacity={0.4}
  ...
  return (
    <>
      ...
      >
        ...
        >
          ...
          >
            <Header />
            <View
              style={{ ...styles.box, backgroundColor: theme.colors.white }}
            >
              <View
                style={{
              ...
              >
                <TouchableOpacity
                  activeOpacity={0.5}
                  onPress={() => qrCodeBottomSheetModalRef.current.present()}
                >
                  <Image
                    style={{
            ...
            >
              ...
              <Image
                style={{
                  width: moderateScale(25),
                  height: moderateScale(25),
                  tintColor: theme.colors.text_Black,
                }}
            ...
            >
              <View
                style={{
                  ...
                  borderBottomColor: theme.colors?.black_gray,
                }}
              >
                {tab.map((item, index) => {
                  return (
                    <View
                      style={{ width: "45%", paddingBottom: verticalScale(4) }}
                    >
                      <TouchableOpacity
                        key={index}
                        activeOpacity={0.5}
                      ...
                      >
                        ...
                        <CustomText
                          ...
                          fontWeight={
                            selectedTab == item?.title ? "600" : "500"
                          }
                          label={item.title}
                          size={16}
                          color={
            ...
            <View style={{ gap: verticalScale(10) }}>
              <View style={{ ...appStyles.rowjustify, gap: moderateScale(20) }}>
                <CustomText
                  ...
                  color={theme.colors.text}
                />
                <TouchableOpacity onPress={() => router.push("/chestRewards")}>
                  <CustomText
      ...
      <CustomBottomSheet
        ...
        bottomSheetModalRef={qrCodeBottomSheetModalRef}
      >
        <QrCodeModal
      ...
      <CustomBottomSheet
        snapPoints={OrderSheetSnapPoints}
        bottomSheetModalRef={livePopupBottomSheetModalRef}
      >
        <LivePopupModal
