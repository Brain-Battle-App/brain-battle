...
export const avatatData = [
  ...
  { icon: images.avatar8 },
  { icon: images.avatar9 },
  { icon: images.avatar10 },
  { icon: images.avatar11 },
  { icon: images.avatar12 },
  { icon: images.avatar13 },
  { icon: images.avatar14 },
  { icon: images.avatar15 },
  { icon: images.avatar16 },
  { icon: images.avatar17 },
  { icon: images.avatar18 },
  { icon: images.avatar19 },
  { icon: images.avatar20 },
  { icon: images.avatar21 },
  { icon: images.avatar22 },
  { icon: images.avatar23 },
  { icon: images.avatar24 },
  { icon: images.avatar25 },
  { icon: images.avatar26 },
  { icon: images.avatar27 },
  { icon: images.avatar28 },
  { icon: images.avatar29 },
  { icon: images.avatar30 },
  { icon: images.avatar31 },
  { icon: images.avatar32 },
  { icon: images.avatar33 },
  { icon: images.avatar34 },
  { icon: images.avatar35 },
  { icon: images.avatar36 },
  { icon: images.avatar37 },
  { icon: images.avatar38 },
  { icon: images.avatar39 },
  { icon: images.avatar40 },
  { icon: images.avatar41 },
  { icon: images.avatar42 },
  { icon: images.avatar43 },
  { icon: images.avatar44 },
  { icon: images.avatar45 },
  { icon: images.avatar46 },
  { icon: images.avatar47 },
  { icon: images.avatar48 },
  { icon: images.avatar49 },
  { icon: images.avatar50 },
  { icon: images.avatar51 },
  { icon: images.avatar52 },
  { icon: images.avatar53 },
  { icon: images.avatar54 },
  { icon: images.avatar55 },
  { icon: images.avatar56 },
...
export const friendData=[
  {image:images.user10,isOnline:true,onlineColor:"#43C62F",},
  {image:images.user12,onlineColor:"#FCB810"},
  {image:images.user13,isOnline:true,onlineColor:"#43C62F"},
  {image:images.user14,isOnline:true,onlineColor:"#FCB810"},
  {image:images.user15,isOnline:true,onlineColor:"#454D51"},
  {image:images.user16,isOnline:true,onlineColor:"#43C62F"},
]
export const rankingData=[
  {name:"Roosevelt HS",sat:"SAT at",id:"#2",image:images.roosevelt},
  {name:"Missouri",sat:"SAT in",id:"#52",image:images.sashBadge},

]
export const userHistoryData=[
  { userProfile:images.user10,gole:"3-2",user1Image:images.user11,points:"36",win:true,user1Online:true,icon:images.sat_profile},
  { userProfile:images.user12,gole:"1-3",user1Image:images.user13,points:"-40",win:false,user1Online:true,icon:images.act_profile},
  { userProfile:images.user14,gole:"3-0",user1Image:images.user15,points:"+20",win:true,user1Online:false,icon:images.sat_profile},
  { userProfile:images.user16,gole:"0-3",user1Image:images.user17,points:"-16",win:false,user1Online:false,icon:images.act_profile},
...
export const country = [
  ...
  { name: "United States", image: images.unitedStates },
...
export const rewardRanks: any = [
  {
    ...
    data: [
      ...
      {
        bedageImage: images.uncommonBadge,
        name: "Uncommon Badge",
        nameColor: "#007CD6",
        value: "7%",
      },
      ...
      {
        bedageImage: images.commonBadge,
        name: "Common Badge",
